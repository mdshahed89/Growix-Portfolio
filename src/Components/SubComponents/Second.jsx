  ...
  return (
    <div className=' grid grid-cols-3 gap-4 max-w-[1300px] mx-auto mt-16 mb-[10rem] px-3 '>
        <div className=' relative '>
            ...
            <p className=' font-light my-3 leading-7 line-clamp-4 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et praesentium eos nulla qui commodi consectetur beatae fugiat. Veniam iste rerum perferendis.</p>
