    ...
    <div className='  '>
      ...
      <div className=' max-w-[1300px] p-3 my-10 mx-auto grid grid-cols-1 md:grid-cols-3 gap-7  '>
        ...
        <div className=' border rounded-lg group  hover:shadow-lg transition-hover duration-300 ease-in-out  '>
          ...
          <div className=' pb-6 pt-16 px-3  text-center font-semibold flex flex-col gap-2 '>
            ...
            <p className=' text-[1.1rem] text-[#4b4b4b] '>mdshahedpersonal@gmail.com</p>
          </div>
        </div>
        ...
        <div className=' border rounded-lg group  hover:shadow-lg transition-hover duration-300 ease-in-out  '>
          ...
          <div className=' pb-6 pt-16 px-3  text-center font-semibold flex flex-col gap-2 '>
            ...
            <p className=' text-[1.1rem] text-[#4b4b4b] '>+8801789548766</p>
          </div>
        </div>
        ...
        <div className=' border rounded-lg group hover:shadow-lg transition-hover duration-300 ease-in-out  '>
          ...
          <div className=' pb-6 pt-16 px-3  text-center font-semibold flex flex-col gap-2 '>
            ...
            <p className=' text-[1.1rem] text-[#4b4b4b] '>761 Safura Green, Satmasjid Road, Dhaka, Bangladesh.</p>
          </div>
        </div>
      ...
      <div className=' max-w-[1300px] mx-auto '>
        ...
        <div className=' text-center '>
          ...
          <p className=' text-[#616161] '>flevnex Inc will arrange your first business consultation totally free of cost</p>
        </div>
