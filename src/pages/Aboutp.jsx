...
import AboutpImg from "../assets/AboutpImg.jpg"
import AboutpImg2 from "../assets/AboutpImg2.jpg"
...
<div className=" h-[25rem] w-full relative before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-black/20 ">
     ...
     <div className=' flex items-start md:gap-0 gap-5 md:items-center md:flex-row flex-col  '>
        ...
        <div className=' flex-1 text-xl text-[#454545] flex flex-col gap-5 '>
          <p>Flevnex is a reliable software development firm dedicated to delivering innovative digital solutions with the latest technologies. Specializing in custom software development, <span className=' bg-[#df5533]/70 px-2 rounded-sm '>web development</span>, <span className=' bg-[#fcd940]/70 px-2 rounded-sm '>AI development</span>, <span className=' bg-[#2ecf29]/70 px-2 rounded-sm '>cloud solutions</span>, <span className=' bg-[#47f1f1]/70 px-2 rounded-sm '>mobile app development</span>, and <span className=' bg-[#5767f3]/70 px-2 rounded-sm '>IT staff augmentation services</span>, we strive to exceed expectations and drive success for our clients.</p>
      ...
      <div className=' p-3 border-2 border-[#0372BF] border-dashed mt-16 '>
        <img src={AboutpImg} alt="" className=' h-[30rem] w-full object-cover ' />
      </div>
      ...
      <div className=' flex items-center md:flex-row flex-col my-14 '>
        <div className=' flex-1 md:order-1 order-2 '>
          ...
          <p className=' text-xl mt-12 text-[#454545] '>It is a great honor and delight for me to share a few words about Flevnex, a company dedicated to delivering exceptional software development services globally. At Flevnex, we help clients achieve their business goals through innovative and reliable software solutions, tailored to enhance efficiency and meet their unique needs.</p>
          <p className=' text-xl mt-6 text-[#454545] '>Our mission is guided by core values: trust, respect, commitment, quality, and teamwork. We believe in honoring our commitments and taking full responsibility for our actions. We value each person's uniqueness, including our clients and partners, and strive to help them reach their full potential. Our dedication ensures mutual growth and success for both Flevnex and our clients.</p>
          <div className=' mt-4 '>
            <p>Md. Sohel Arman</p>
            <p>Co-founder & CEO</p>
          </div>
        ...
        <div className=' md:order-2 order-1 flex-1 flex justify-center items-center '>
          ...
          <img src={AboutpImg2} alt="" className=' h-[30rem] w-[30rem] object-cover rounded-full ' />
          </div>
        </div>
      </div>
