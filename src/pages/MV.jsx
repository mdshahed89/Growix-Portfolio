...
import VisionImg from "../assets/VissionImg.png"
    ...
    <div className=" min-h-[100vh] ">
      ...
      <div className=" flex items-center md:flex-row flex-col px-2 gap-7 my-10 ">
        <div className=" flex-1 h-full">
          <img src={MissionImg} alt="" className=" w-full min-h-[25rem] h-full object-cover " />
        </div>
        <div className=" flex-1 lg:pl-[3%] ">
          <h3 className=" text-[1.6rem] font-semibold text-[#0372BF] ">Our Mission</h3>
          <p className=" text-xl text-[#454545] mt-6 ">At Flevnex, our mission is to empower businesses by delivering cutting-edge software solutions that drive success. We are unwavering in our commitment to innovation, excellence, and customer satisfaction. By continually pushing the boundaries of technology, we ensure our solutions uphold the highest standards of quality, reliability, and performance.</p>
      ...
      <div className=" flex items-center md:flex-row flex-col px-2 gap-7 my-20 ">
        ...
        <div className=" flex-1 md:order-2 order-1 ">
          <img src={VisionImg} alt="" className=" w-full min-h-[25rem] h-full object-cover " />
        </div>
      </div>
